...
namespace pe::api::debugging
{
	...
	{
	public:
		RTTI_DECLARE_COMPONENT(::pe::api::debugging::DebugDrawableComponent) { NO_RTTI_PROPERTY(); }
	...
	{
	public:
		RTTI_DECLARE_COMPONENT(::pe::api::debugging::DebugDrawStateWorldComponent) { NO_RTTI_PROPERTY(); }
