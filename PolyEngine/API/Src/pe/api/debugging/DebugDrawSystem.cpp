...
#include <pe/api/ui/ScreenSpaceTextComponent.hpp>
...
void pe::api::debugging::DebugDrawSystem::DrawLine(Scene* scene, const Vector& begin, const Vector& end, const Color& color)
{
	if (!gDebugConfig.DebugRender)
		return;
...
void pe::api::debugging::DebugDrawSystem::DrawBox(Scene* scene, const Vector& mins, const Vector& maxs, const Color& color)
{
	if (!gDebugConfig.DebugRender)
		return;
...
void pe::api::debugging::DebugDrawSystem::DrawBox(Scene* scene, const AABox & box, const Color & color)
{
	DrawBox(scene, box.GetMin(), box.GetMax(), color);
}

void pe::api::debugging::DebugDrawSystem::DrawFrustum(Scene* scene, const Frustum& frustum, const Matrix& viewFromWorld, const Color color)
{
	Matrix clipFromView;
...
void pe::api::debugging::DebugDrawSystem::DrawFrustumPoints(Scene* scene, const Dynarray<Vector>& cornersInWorld, const Color color)
{
...
void pe::api::debugging::DebugDrawSystem::DrawCircle(Scene* scene, const Vector& position, float radius, Vector orientation, const Color& color)
{
	if (!gDebugConfig.DebugRender)
		return;
...
void pe::api::debugging::DebugDrawSystem::DrawSphere(Scene* scene, const Vector& position, float radius, const Color& color)
{
	if (!gDebugConfig.DebugRender)
		return;
...
void pe::api::debugging::DebugDrawSystem::DrawArrow(Scene* scene, Vector position, Vector directionVector, const Color& color)
{
	if (!gDebugConfig.DebugRender)
		return;
...
void pe::api::debugging::DebugDrawSystem::DrawText2D(Scene* scene, const Vector2i& screenPosition, String text, size_t fontSize, const Color& color)
{
	if (!gDebugConfig.DebugRender)
		return;
