...
namespace pe::api::rendering::lighting
{
	class ENGINE_DLLEXPORT AmbientLightWorldComponent : public ComponentBase
	{
	public:
		RTTI_DECLARE_COMPONENT(::pe::api::rendering::lighting::AmbientLightWorldComponent) { NO_RTTI_PROPERTY(); }
	...
	{
	public:
		RTTI_DECLARE_COMPONENT(::pe::api::rendering::lighting::DirectionalLightComponent) { NO_RTTI_PROPERTY(); }
	...
	{
	public:
		RTTI_DECLARE_COMPONENT(::pe::api::rendering::lighting::PointLightComponent) { NO_RTTI_PROPERTY(); }
	...
	{
	public:
		RTTI_DECLARE_COMPONENT(::pe::api::rendering::lighting::SpotLightComponent) { NO_RTTI_PROPERTY(); }
