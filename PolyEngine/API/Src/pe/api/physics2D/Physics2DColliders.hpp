...
namespace pe::api::physics2D
{
	...
	{
	public:
		RTTI_DECLARE_COMPONENT(::pe::api::physics2D::Box2DColliderComponent) { NO_RTTI_PROPERTY(); }
	...
	{
	public:
		RTTI_DECLARE_COMPONENT(::pe::api::physics2D::Circle2DColliderComponent) { NO_RTTI_PROPERTY(); }
